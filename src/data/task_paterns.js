export const paterns = {
  ...
  medical_workflow: {
    date: "2025-03-23",
    observer: "corentin",
    $created_on: "medical_workflow",
    $created_on_content: {
      actors: ["chibani@u-pec.fr"],
      workflow_id: "medical_workflow",
      workflow_label: "Medical workflow",
      children: [
        {
          form_label: "daily assessment",
          form_id: "daily_1",
          formData: {
            form_version: "1.0.2",
            form_label: "Identification page",
            form: [
              {
                field_hint: "Put the name of the observer",
                field_required: true,
          ...
          children: [
            {
              ...
              formData: {
                form_version: "1.0.2",
                form_label: "General constitution",
                form: [
                  {
                    field_hint: "Put the name of the observer",
                    field_required: true,
        ...
        },
        {
          ...
          formData: {
            form_version: "1.0.2",
            form_label: "Cardiorespiratory examination",
            form: [
              {
                field_hint: "Put the name of the observer",
                field_required: true,
    ...
    email: "corentin.solacroup@etu.u-pe.fr",
  },
};
